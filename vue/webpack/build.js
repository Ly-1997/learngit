...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vue_min__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vue_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__vue_min__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common__ = __webpack_require__(6);
// es6 module
// 项目入口文件
...
console.log(__WEBPACK_IMPORTED_MODULE_1__common__["c" /* num2 */],__WEBPACK_IMPORTED_MODULE_1__common__["a" /* add */](4,5,6));

new __WEBPACK_IMPORTED_MODULE_0__vue_min___default.a({
    el: '#app',
    components: {
        // App
        App: __WEBPACK_IMPORTED_MODULE_1__common__["b" /* default */]
    },
    template: '<App />'
}); 
...
var num=1;   //声明并导出，作为一整个对象key导出
var num2=2;
    //    声明再导出
function add(x,y) {
    return x+y;
}
/* harmony default export */ __webpack_exports__["b"] = (app); //抛出app
